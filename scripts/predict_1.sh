...
CUDA_VISIBLE_DEVICES=0  python predict/predict.py \
    ...
    --checkpoint_dir ${output_dir}/CodeLlama-13b-sql-qlora-code/checkpoint-2000 \
    --quantization_bit 4 \
    --predicted_out_filename ${output_dir}/predict/pred_spider_test_codellama13b_code_2000.sql >> ${pred_log}
